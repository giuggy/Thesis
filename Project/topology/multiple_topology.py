...
def myNet(super_ip, super_port, local_ip, local_port, attack):
    ...
    net.terms += activation_bash(host=h1, file='host_modbus.sh', port=MODBUS_PORT)
    net.terms += activation_bash(host=h4, file='host_modbus.sh', port=MODBUS_PORT, target=target)

    net.terms += activation_bash(host=h7, file='host_modbus.sh', port=MODBUS_PORT)
    ...
    net.terms += activation_bash(host=h2, file='host_dnp3.sh', port=DNP3_PORT)
    net.terms += activation_bash(host=h5, file='host_dnp3.sh', port=DNP3_PORT)
    net.terms += activation_bash(host=h8, file='host_dnp3.sh', port=DNP3_PORT, target=target)
    ...
    if attack == 1:
        ...
        target = None
    net.terms += activation_bash(host=h3, file='host_iec.sh', port=IEC_PORT, target=target)
    net.terms += activation_bash(host=h6, file='host_iec.sh', port=IEC_PORT)
    net.terms += activation_bash(host=h9, file='host_iec.sh', port=IEC_PORT)


    print("COMMAND:" + CMD)
    cmd = "bash " + PATH + 'hmi.sh' + " " + \
